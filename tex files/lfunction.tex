...
The computation of any derivative of $\Lambda(s,f)$ can easily but painfully be done using the following:
...
&-\epsilon_N A^{2-s}\left( \ln (ABC_1) \Gamma_0(2-s, B)\Gamma_0(2-s,C_1)+\Gamma_0(2-s,B)\Gamma_1(2-s,C_1) + \Gamma_1(2-s,B)\Gamma_0(2-s,C_1)\right)\\
& +\epsilon_N A^{2-s}\left( \ln (ABC_2) \Gamma_0(2-s, B)\Gamma_0(2-s,C_2)+\Gamma_0(2-s,B)\Gamma_1(2-s,C_2)+\Gamma_1(2-s,B)\Gamma_0(2-s,C_2)\right) \left.  \right)
\end{split}
\end{equation*}
